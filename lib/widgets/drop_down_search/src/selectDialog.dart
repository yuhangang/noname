    ...
    if (widget.itemBuilder != null)
      ...
      return ListTile(
        title: Text(
          ...
          style: !_manageSelectedItemVisibility(item)
              ? widget.dropDownItemTextStyle?.copyWith(
                  color: widget.dropDownItemTextStyle?.color?.withOpacity(0.6))
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Icon(
                            Icons.add,
                            color: widget.searchBoxStyle?.color,
                          ),
                        ),
                      ),
                    ),
